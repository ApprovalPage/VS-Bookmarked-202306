...
lib.ssMetadata = [
		{name:"VS_Bookmarked_Flowers_970x250_atlas_NP_1", frames: [[0,0,1940,500],[0,502,444,250]]}
];
...
// stage content:
(lib.VS_Bookmarked_Flowers_970x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
