...
(lib.LensFlare250px = function() {
	this.initialize(ss["VS_Bookmarked_Flowers_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.VS_Bookmarked_Flowers_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// L_jpg
	this.instance_2 = new lib._728x90flowers();
