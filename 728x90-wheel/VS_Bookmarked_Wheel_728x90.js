...
(lib.LensFlare250px = function() {
	this.initialize(ss["VS_Bookmarked_Wheel_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.VS_Bookmarked_Wheel_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/VS_Bookmarked_Wheel_728x90_atlas_P_1.png", id:"VS_Bookmarked_Wheel_728x90_atlas_P_1"},
		{src:"images/VS_Bookmarked_Wheel_728x90_atlas_NP_1.jpg", id:"VS_Bookmarked_Wheel_728x90_atlas_NP_1"}
	],
	preloads: []
};
