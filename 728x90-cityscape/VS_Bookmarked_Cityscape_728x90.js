...
lib.ssMetadata = [
		{name:"VS_Bookmarked_Cityscape_728x90_atlas_P_1", frames: [[0,0,728,90]]},
		{name:"VS_Bookmarked_Cityscape_728x90_atlas_NP_1", frames: [[0,0,444,250]]}
];
...
(lib._728x90cityscape = function() {
	this.initialize(ss["VS_Bookmarked_Cityscape_728x90_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib.LensFlare250px = function() {
	this.initialize(ss["VS_Bookmarked_Cityscape_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.VS_Bookmarked_Cityscape_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	mask._off = true;
	mask.graphics.p("A1PHCIAAuDMAqfAAAIAAODg");
	...
	// L_jpg
	this.instance_2 = new lib._728x90cityscape();
	...
	this.shape_1.graphics.f("#999999").s().p("Eg6bAImIAAxLMB03AAAIAARLg");
